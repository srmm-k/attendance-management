...
<div class="attendance-detail__container">
    ...
    <form action="{{ route('attendance.update', $attendance->id) }}" method="POST"></form>
    @csrf
    @method('PUT')
    ...
    <div class="attendance-detail__card">
        <div class="attendance-detail__item">
            ...
            <span class="attendance-detail__data">{{ $attendance->user->name }}</span>
        </div>

        <div class="attendance-detail__item">
            <span class="attendance-detail__label">日付</span>
            <span class="attendance-detail__data">{{ $attendance->date }}</span>
        </div>
        ...
        <div class="attendance-detail__item">
            <span class="attendance-detail__label">休憩2</span>
            <div class="attendance-detail__break-wrapper">
        ...
        <div class="attendance-detail__item">
            ...
            <div class="attendance-detail__textarea-wrapper">
                <textarea class="attendance-detail__textarea" readonly>{{ $attendance->note ?? 'なし' }}</textarea>
            </div>
        </div>
    </div>
    <div class="attendance-detail__back-link">
